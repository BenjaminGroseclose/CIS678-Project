...
#SBATCH --job-name=text-detection-xsum ## Name of job

#SBATCH --output=text-detection-xsum-.%j.out ##Name of output file

plm_dir="allenai/longformer-base-4096"
seed=42629309
data_path="../data/domain_specific_cross_models/xsum"
